...
enum {
	...
	NVME_CTRL_OAES_ZONE_DESC_CHANGED	= 1 << 27,
...
enum {
	...
	NVME_IOCS_VECTOR_ZND		= 1 << NVME_IOCS_ZND,
};
...
#define NVME_ID_NS_ZONE_OZCS_RAZB(ozcs)			((ozcs >> 0 & 0x1))
...
enum {
	 ...
	 * ZNS Specific Status:
	 */
	NVME_ZONE_BOUNDARY_ERROR	= 0x1b8,
	NVME_ZONE_IS_FULL		= 0x1b9,
	NVME_ZONE_IS_READ_ONLY		= 0x1ba,
	NVME_ZONE_IS_OFFLINE		= 0x1bb,
	NVME_ZONE_INVALID_WRITE		= 0x1bc,
	NVME_ZONE_TOO_MANY_ACTIVE	= 0x1bd,
	NVME_ZONE_TOO_MANY_OPEN		= 0x1be,
	NVME_ZONE_INVALID_STATE_TRANS	= 0x1bf,
